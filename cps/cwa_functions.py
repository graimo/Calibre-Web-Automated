            ...
            for setting in integer_settings:
                ...
                if value is not None:
                    try:
                        ...
                        elif setting == 'calibre_metadata_timeout':
                            int_value = max(10, min(300, int_value))  # Clamp between 10 and 300 seconds
